...
export default function DetailTrendingBlog() {
  return (
    <section>
      <article className="mx-auto w-[95%] max-w-[1150px]">
        <h1 className="text-center mt-[6.5rem] text-[32px] md:text-[36px] font-medium">
          Founders Note
        </h1>
        <p className="mt-[2rem] leading-[30px] px-8 md:px-0">
          ...
          photographer who relishes the polished + proper portraits, then you've
          come to the wrong place. I'm all about the in-between moments; I
          thrive in the details. I'm Vikas Alagarsamy IF YOU LIKE
